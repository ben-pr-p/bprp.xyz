...
_Towards a rigorous, practical, and faithfully optimistic collapsology_

<Alert type="info" title="Edit: Out of Date">
  I was not accepted into programs I applied for, and have chosen not to
  re-apply for 2025. As a result, this is out of date, but I'm still leaving it
  here!
</Alert>
...
<Alert type="info" title="Note">
  Right now, I am not so interested in working on "the social cost of carbon" or
  other questions of mitigation, but instead focused on adaptation strategies.
</Alert>
