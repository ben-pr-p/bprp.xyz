...
<Alert type="info">
This is now built-in to Marimo, so you don't need to hack this yourself anymore! Marimo has added [SQL support powered by DuckDB](https://x.com/marimo_io/status/1805645628942544935). It's awesome!
</Alert>
